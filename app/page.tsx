...
export default function IndexPage() {
  ...
  return (
    ...
    //     />
    //   </Head>
      <div className="container mx-auto flex aspect-[1/1.8] min-h-screen flex-col items-center justify-center  p-6" style={{ backgroundImage: `url(images/PRD/p1-bg.png)` }}>
